...
class EditarPilarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (extras != null) {
            ...
            val responsavel = extras.getInt("pilar_responsavel")
            ...
            binding.etEditarCodigoResponsavel.setText(responsavel.toString())
    ...
    private fun salvarEdicaoPilar() {
        ...
        val responsavelStr = binding.etEditarCodigoResponsavel.text.toString()
        val dataInicio = binding.etEditarDataInicio.text.toString()
        val dataTermino = binding.etEditarDataTermino.text.toString()

        if (nome.isEmpty() || descricao.isEmpty() || responsavelStr.isEmpty() || dataInicio.isEmpty() || dataTermino.isEmpty()) {
            Toast.makeText(this, "Preencha todos os campos!", Toast.LENGTH_SHORT).show()
            return
        }
    //Código de responsável é do tipo Int, então não posso usar o métod isnull com ele
        val responsavel = responsavelStr.toIntOrNull()
        if (responsavel == null) {
            Toast.makeText(this, "Código do responsável inválido!", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        if (pilarId != -1L) {
            ...
            val values = android.content.ContentValues().apply {
                ...
                put(com.example.mpi.data.PilarContract.UserEntry.COL_RESPONSAVEL, responsavel)
